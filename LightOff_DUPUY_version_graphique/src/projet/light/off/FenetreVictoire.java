...
private int coups;
     ...
     */
    public FenetreVictoire(int coups) {
        initComponents();
        victoire.setText("\n VICTOIRE \n \n \n Bravo! \n\nVous avez gagné en "+ coups +" coups");
    }
    ...
    private void initComponents() {
        ...
        victoire.setEditable(false);
        victoire.setBackground(new java.awt.Color(204, 255, 204));
        victoire.setColumns(20);
        victoire.setFont(new java.awt.Font("Kristen ITC", 1, 18)); // NOI18N
        victoire.setRows(5);
        victoire.setText("            VICTOIRE \n \nBravo!\nTu as réussis en coups");
